        ...
        <div class="modal-content center">
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <input id="address_reg" type="text" class="validate">
                        <label for="address_reg">Address</label>
                    </div>

                    

                    <div class="input-field col s6">
                        <input id="contact_reg" type="text" class="validate">
                        <label for="contact_reg">Contact Number</label>
                    </div>
                ...
                <a href="javascript:void(0)" id="submit_reg" class="waves-effect waves-light btn" style="background: #1D6E95 !important;">Register</a>
