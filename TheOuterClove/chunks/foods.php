                                ...
                                <div class="card-content">
                                    <span class="card-title activator grey-text text-darken-4">
                                        <a class="black-text" href="">
                                            <?php echo '<strong>' . $arr_all[$i + $j - 2]['fname'] . '</strong>'; ?>
                                        </a>
                                        <i class="material-icons right">more_vert</i>
                                    </span>
                                    <p><strong>Price: Rs. <?php echo $arr_all[$i + $j - 2]['price']; ?></strong></p>
                                    <div class="card-content">
                                        
                                    </div>
                                    <div class="card-content center">
                                        <a href="backends/order-food.php?id=<?php echo $arr_all[$i + $j - 2]['id']; ?>"
                                           style="background: #1D6E95;"
                                           class="btn waves-effect waves-block waves-light" href="">Order Now!</a>
                                    </div>
                                </div>
                                <div class="card-reveal">
                                    <span class="card-title grey-text text-darken-4">
                                        <?php echo $arr_all[$i + $j - 2]['fname']; ?>
